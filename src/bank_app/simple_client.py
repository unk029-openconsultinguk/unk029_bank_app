    ...
    def process_query(self, user_input: str, client_id: str = "default") -> str:
        ...
        try:
            ...
            messages = [
                ...
                "Always be friendly and confirm transactions. If user doesn't provide an "
                "account number, ask them for it.",
            ]
    ...
    def _call_mcp_tool(self, tool_name: str, **kwargs) -> dict:
        ...
        try:
            with httpx.Client(timeout=10.0) as client:
                ...
                response = client.post(f"{self.mcp_url}/mcp", json=payload)
